...
namespace Recipe_Book.Controllers
{
    public class IngredientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Quantity")] Ingredients ingredients)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Quantity")] Ingredients ingredients)
        {
